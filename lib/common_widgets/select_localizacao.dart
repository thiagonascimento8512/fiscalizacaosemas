...
class SelectLocalizacao extends StatefulWidget {
  const SelectLocalizacao({
    super.key,
    this.initialPosition = const LatLng(-1.409612, -48.468992),
  });
  final LatLng initialPosition;

  @override
  State<SelectLocalizacao> createState() => _SelectLocalizacaoState();
}

class _SelectLocalizacaoState extends State<SelectLocalizacao> {
